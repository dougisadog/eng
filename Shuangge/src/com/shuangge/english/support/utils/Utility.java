...
public class Utility {
    ...
    public static String convertParamsToUrl(HttpReqFactory.ReqParam[] params) {
        if (params == null) {
            return "";
        }
        ...
        try {
	        for (HttpReqFactory.ReqParam param : params) {
	            ...
	            if (!TextUtils.isEmpty(param.getKey()) || param.getKey().equals("description") || param.getKey().equals("url")) {
	            	if (first) {
	            		first = false;
	            	}
	            	else {
	            	...
	            	/*
	            	try {
	                    sb.append(URLEncoder.encode(param.getKey(), "UTF-8")).append("=").append(URLEncoder.encode(param.getValue().toString(), "UTF-8"));
	                } 
...
//
	...
	public static boolean isCertificateFingerprintCorrect(Context context) {
        try {
            ...
            //debug
            if ("3273B3935BF72EEDC0A86B4CFE4F4428".toUpperCase().equals(strResult)) {
                return false;
            }
            //relaease
            if ("3273B3935BF72EEDC0A86B4CFE4F4428".toUpperCase().equals(strResult)) {
