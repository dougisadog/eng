package com.shuangge.english.support.task;
...
//                }
     ...
     *                               {@link AsyncTask.Status#RUNNING} or {@link AsyncTask.Status#FINISHED}.
     */
    public MyAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    public MyAsyncTask<Params, Progress, Result> executeOnExecutor2(Executor exec,
            Params[] params) {
        if (mStatus != Status.PENDING) {
            switch (mStatus) {
                case RUNNING:
    ...
    public void executeOnIO(Params... params) {
        executeOnExecutor2(IO_THREAD_POOL_EXECUTOR, params);
    }

    public void executeOnNormal(Params... params) {
        executeOnExecutor2(THREAD_POOL_EXECUTOR, params);
    }
    
    public void executeOnNormal2(Params[] params) {
    	executeOnExecutor2(THREAD_POOL_EXECUTOR, params);
    }

    public void executeOnWaitNetwork(Params... params) {
    	executeOnExecutor2(WAIT_DOWNLOAD_THREAD_POOL_EXECUTOR, params);
    }
    
    public void executeOnWaitNetwork2(Params[] params) {
    	executeOnExecutor2(WAIT_DOWNLOAD_THREAD_POOL_EXECUTOR, params);
    }
