...
import com.shuangge.english.network.secretmsg.TaskReqSecretGetMembers;
...
import com.shuangge.english.view.secretmsg.adapter.AdapterClassMember;
 ...
 *
 */
public class FragmentClassMembers extends BaseSecretFriendFragment implements OnClickListener, OnItemClickListener {
	...
	private void requestDatas() {
		...
		new TaskReqSecretGetMembers(0, new CallbackNoticeView<Void, Boolean>() {
...
//			AtyClassSearch.startAty(getActivity());
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		GlobalRes.getInstance().getBeans().setCurrentFriendNo(((ClassMemberData) adapter.getItem(position-1)).getUserNo());
		GlobalRes.getInstance().getBeans().setCurrentFriendName(((ClassMemberData) adapter.getItem(position-1)).getName());
