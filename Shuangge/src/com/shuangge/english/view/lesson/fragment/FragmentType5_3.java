...
public class FragmentType5_3 extends BaseType5 implements OnClickListener {
	
	private EntityResType5 data1, data2, data3, data4;
	
	public FragmentType5_3() {
		super();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mainView = inflater.inflate(R.layout.item_lesson_type5_3, (ViewGroup) getActivity().findViewById(R.id.vp), false);
	...
	public void onRefreshView() {
		...
		refreshModule(type5_1, imgLock1, imgStart1, rbStar1, imgModule1, R.drawable.icon_lessontype5_6, R.drawable.icon_lessontype5_6_2, R.drawable.icon_lessontype5_6_3);
		refreshModule(type5_2, imgLock2, imgStart2, rbStar2, imgModule2, R.drawable.icon_lessontype5_7, R.drawable.icon_lessontype5_7_2, R.drawable.icon_lessontype5_7_3);
		refreshModule(type5_3, imgLock3, imgStart3, rbStar3, imgModule3, R.drawable.icon_lessontype5_8, R.drawable.icon_lessontype5_8_2, R.drawable.icon_lessontype5_8_3);
