...
public class OptionWithSound extends RelativeLayout implements OnClickListener, OnTouchListener {
	...
	private static final int WRONG_COLOR = 0xFF43454A;
	...
	public OptionWithSound(Context context, String txt, int width, int height, int left, int top, String path, OnCompletionListener onCompletionListener) {
		super(context);
		createContentBtn(context, txt, width);
...
//		}
	...
	private void createContentBtn(Context context, String txt, int width) {
		...
		LayoutParams layoutParams = ViewUtils.setRelativeMargins(txtContent, 
				RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT, 0, 0, DensityUtils.dip2px(context, 50), 10);
	...
	public void setWrong() {
		this.setBackgroundResource(R.drawable.bg_lesson_wrong);
		if (null != txtContent) {
