...
//    	return (int) (source.toString().length()*FontSpace); 
    	return w;
    }
    
    public boolean isWidthLimit() {
		return widthLimit;
	}

	public void setWidthLimit(boolean widthLimit) {
		this.widthLimit = widthLimit;
	}

	private boolean widthLimit = false; //是否开启宽度检测 默认关闭
