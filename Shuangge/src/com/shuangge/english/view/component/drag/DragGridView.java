package com.shuangge.english.view.component.drag;
...
public class DragGridView extends GridView {
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (mDragAdapter.cannotDrag(mDragPosition)) {
				return super.dispatchTouchEvent(ev);
			}
...
//			mDragBitmap = ViewUtils.loadBitmapFromView(mStartDragItemView);
...
//			}
		...
		case MotionEvent.ACTION_UP:
			...
			if (!isDrag && mDragPosition != AdapterView.INVALID_POSITION) {
				onClick(mStartDragItemView, mDragPosition);
			}
			break;
		}
		return super.dispatchTouchEvent(ev);
	...
	private void onSwapItem(int moveX, int moveY) {
		...
		if (!mDragAdapter.cannotDrag(tempPosition) && tempPosition != mDragPosition
