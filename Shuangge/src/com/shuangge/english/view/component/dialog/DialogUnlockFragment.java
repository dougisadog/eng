...
public class DialogUnlockFragment extends DialogFragment1 implements OnClickListener {

	public static interface UnlockCallBackDialogConfirm {
	...
	private UnlockCallBackDialogConfirm callback;
	private TextView txtDialogTitleCn, txtDialogTitleEn;
	private FrameLayout flDialogCancel, flDialogSubmit;
	
	private int position;
	
	public DialogUnlockFragment() {
		super();
	}
	
	public DialogUnlockFragment(UnlockCallBackDialogConfirm callback, String titleStrEn, String titleStrCn, int position ) {
		super();
	...
	public DialogUnlockFragment(UnlockCallBackDialogConfirm callback, String titleStrEn, String titleStrCn, int position, int theme) {
		super();
		this.callback = callback;
		this.titleStrEn = titleStrEn;
		this.titleStrCn = titleStrCn;
	...
	public DialogUnlockFragment(UnlockCallBackDialogConfirm callback, String titleStrEn, String titleStrCn, int position, String btnStrSubmit, String btnStrExit ) {
		super();
		this.callback = callback;
		this.titleStrEn = titleStrEn;
		this.titleStrCn = titleStrCn;
...
//		View v = inflater.inflate(R.layout.dialog_unlock, null);// 得到加载view
