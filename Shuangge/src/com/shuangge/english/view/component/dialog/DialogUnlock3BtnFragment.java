...
public class DialogUnlock3BtnFragment extends DialogFragment1 implements OnClickListener {

	public static interface Unlock3BtnCallBackDialogConfirm {
	...
	private Unlock3BtnCallBackDialogConfirm callback;
	private TextView txtDialogTitleCn, txtDialogTitleEn;
	
	public DialogUnlock3BtnFragment() {
		super();
	}
	
	public DialogUnlock3BtnFragment(Unlock3BtnCallBackDialogConfirm callback, String titleStrEn, String titleStrCn) {
		super();
	...
	public DialogUnlock3BtnFragment(Unlock3BtnCallBackDialogConfirm callback, String titleStrEn, String titleStrCn, int theme) {
		super();
		this.callback = callback;
		this.titleStrEn = titleStrEn;
		this.titleStrCn = titleStrCn;
...
//		View v = inflater.inflate(R.layout.dialog_unlock_3btn, null);// 得到加载view
