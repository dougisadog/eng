 ...
 *
 */
public class TaskReqShareInviteNo extends BaseTask<Long, Void, Boolean> {
	
	public TaskReqShareInviteNo(int tag, CallbackNoticeView<Void, Boolean> callback, Long... params) {
